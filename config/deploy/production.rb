  ...
  task :export do
    on roles(:app) do
      execute [
        ...
        'rvmsudo',
        'RAILS_ENV=production bundle exec foreman export --app dradio --user deploy -l /var/log -f ./Procfile upstart /etc/init -c worker=2,node=1 -e environments/production.env'
      ].join(' ')
    end
  end
