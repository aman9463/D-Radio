...
task :export do
    ...
    on roles(:app) do
      execute [
        ...
        'rvmsudo',
        'RAILS_ENV=production bundle exec foreman export --app dradio --user deploy -l /var/log/a -f ./Procfile upstart /etc/init -m faye=1,worker=1 –e environments/production.env'
      ].join(' ')
    end
end
